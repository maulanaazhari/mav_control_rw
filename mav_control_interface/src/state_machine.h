...
class StateMachineDefinition : public msm_front::state_machine_def<StateMachineDefinition>
{
 ...
 public:
  ...
  struct transition_table : boost::mpl::vector<
      ...
      msm_front::Row<RemoteControl    , RcUpdate          , RCReadyForOdometry, SetReferenceAttitude, RcModeManual >,
      msm_front::Row<RemoteControl    , OdometryWatchdog  , InternalTransition, PrintOdometryWatchdogWarning, OdometryOutdated >,
      //  +---------+-------------+---------+---------------------------+----------------------+
      msm_front::Row<RCReadyForOdometry, RcUpdate         , RemoteControl     , SetReferenceAttitude, RcModeNotManual >,
      msm_front::Row<RCReadyForOdometry, RcUpdate         , InternalTransition, SetReferenceAttitude, RcModeManual >,
      msm_front::Row<RCReadyForOdometry, OdometryUpdate   , HaveOdometry      , SetOdometry         , NoGuard >,
      msm_front::Row<RCReadyForOdometry, OdometryWatchdog , RemoteControl     , PrintOdometryWatchdogWarning, OdometryOutdated >,
      //  +---------+-------------+---------+---------------------------+----------------------+
...
private:
  ...
  struct RCReadyForOdometry : public msm_front::state<>
  {
    template<class Event, class FSM>
    void on_entry(Event const& evt, FSM& fsm)
    {
      fsm.PublishStateInfo("RCReadyForOdometry");
    }
  };
